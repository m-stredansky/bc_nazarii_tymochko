...
# Add the correct path to Sam_LoRA/src to sys.path
sys.path.append(str(FOLDER_DIR / 'Sam_LoRA'))
# sys.path.append("/Users/nazar228/Desktop/try1/digital_twin/Sam_LoRA")

# Now you can import the necessary modules
from segment_anything import sam_model_registry, SamAutomaticMaskGenerator, SamPredictor
from segment_anything import build_sam_vit_b
from src.lora import LoRA_sam  # Importing LoRA_sam from lora.py inside 'src'
...
sam_checkpoint = FOLDER_DIR / 'Sam_LoRA' / 'sam_vit_b_01ec64.pth'
lora_weights = FOLDER_DIR / 'Sam_LoRA' / 'lora_rank512.safetensors' 
rank = 512  
...
plt.axis('off')
plt.savefig(FOLDER_DIR / 'output_lora' / 'img1__LoRA.png')
plt.close()
...
# plt.tight_layout()
# plt.savefig(FOLDER_DIR / 'output' / 'img1_histogram.png')
# plt.close()
...
plt.xticks(bin_edges, rotation=90, ha='right')
plt.tight_layout()
plt.savefig(FOLDER_DIR / 'output_lora' / 'img1_histogram.png')
plt.close()
...
# Save using OpenCV for clean binary output
cv2.imwrite(FOLDER_DIR / 'output_lora' / 'img1_mask_lora.png', bounding_box_mask)