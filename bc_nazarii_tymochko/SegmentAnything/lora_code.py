...
# sys.path.append("/Users/nazar228/Desktop/folder1/bc_nazarii_tymochko/segment-anything")
...
# from bc_nazarii_tymochko.SegmentAnything.lora_code import LoRA_sam  # if it's in the same folder as lora.py
...
# Add both source folders to sys.path
sys.path.append("/Users/nazar228/Desktop/folder1/bc_nazarii_tymochko/segment-anything")
sys.path.append("/Users/nazar228/Desktop/folder1/Sam_LoRA/src")
...
sam_checkpoint = '/Users/nazar228/Desktop/folder1/Sam_LoRA/sam_vit_b_01ec64.pth'
lora_weights = '/Users/nazar228/Desktop/folder1/Sam_LoRA/lora_rank512.safetensors'  
rank = 512  
...
image_original = cv2.imread('/Users/nazar228/Desktop/folder1/bc_nazarii_tymochko/img1.jpg')
...
sinter_stone_masks = filter_sinter_stones(filtered_masks, area_range=(10, 5000), min_aspect_ratio=0.5, min_iou_with_largest=0.5)
...
plt.axis('off')
plt.savefig('/Users/nazar228/Desktop/folder1/outputs/128_MBR_LoRA.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/Users/nazar228/Desktop/folder1/outputs/128_histogram_equivalent_circle_diameter.png')
plt.close()

# lt_5mm = [x for x in equivalent_circle_diameters if x < 5]
# btw_5_50mm = [x for x in equivalent_circle_diameters if 5 <= x <= 50]
# gt_50mm = [x for x in equivalent_circle_diameters if x > 50]

# counts = [len(lt_5mm), len(btw_5_50mm), len(gt_50mm)]
# labels = ['< 5 mm', '5–50 mm', '> 50 mm']

# plt.figure(figsize=(12, 6))
# bars = plt.bar(labels, counts, color=['red', 'blue', 'green'], alpha=0.8, edgecolor='black')
# plt.title('Distribution of Equivalent Circle Diameter')
# plt.ylabel('Number of Particles')
# plt.tight_layout()
# plt.savefig('/Users/nazar228/Desktop/folder1/outputs/128_grouped_equiv_circle_diam.png')
# plt.close()
...
plt.xticks(bin_edges, rotation=90, ha='right')
plt.tight_layout()
plt.savefig('/Users/nazar228/Desktop/folder1/outputs/128_histogram_major_axis.png')
plt.close()

counts, bin_edges = np.histogram(area, bins=40)
plt.figure(figsize=(12, 6))
plt.hist(area, bins=40, color='blue', alpha=0.8, edgecolor='black')
plt.title('Histogram of Equivalent Feret diameter')
plt.xlabel('Equivalent Feret Diameter (mm)')
plt.ylabel('Frequency')
plt.xticks(bin_edges, rotation=90, ha='right')
plt.tight_layout()
plt.savefig('/Users/nazar228/Desktop/folder1/outputs/128_histogram_area.png')
plt.close()
...
visual_mask = (combined_mask / combined_mask.max()) * 255
visual_mask = visual_mask.astype(np.uint8)
cv2.imwrite('/Users/nazar228/Desktop/folder1/128_combined_mask_vis.png', visual_mask)


plt.figure(figsize=(12, 8))
plt.imshow(combined_mask, cmap='nipy_spectral')  # colorful mapping
plt.axis('off')
plt.title('Labeled Mask')
plt.tight_layout()
plt.savefig('/Users/nazar228/Desktop/folder1/128_visual_combined_mask.png')
plt.close()