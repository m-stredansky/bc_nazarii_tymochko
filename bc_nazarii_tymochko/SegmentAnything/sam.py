...
sinter_stone_masks = filter_sinter_stones(filtered_masks, area_range=(10, 5000), min_aspect_ratio=0.8, min_iou_with_largest=0.8)
...
plt.axis('off')
plt.savefig('/home/nt646jh/directory/folder/bc_nazarii_tymochko/32_MBR_LoRA.png')
plt.close()
...
plt.tight_layout()
plt.savefig('/home/nt646jh/directory/folder/bc_nazarii_tymochko/32_histogram_equivalent_circle_diameter.png')
plt.close()
...
plt.xticks(bin_edges, rotation=90, ha='right')
plt.tight_layout()
plt.savefig('/home/nt646jh/directory/folder/bc_nazarii_tymochko/32_histogram_major_axis.png')
plt.close()
...
plt.xticks(bin_edges, rotation=90, ha='right')
plt.tight_layout()
plt.savefig('/home/nt646jh/directory/folder/bc_nazarii_tymochko/32_histogram_area.png')
plt.close()
